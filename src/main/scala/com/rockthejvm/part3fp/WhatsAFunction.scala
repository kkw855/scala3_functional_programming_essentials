...
//noinspection TypeAnnotation,ScalaUnusedSymbol,NotImplementedCode,DuplicatedCode
object WhatsAFunction {
  ...
  // 1
  val concatenator: (a: String, b: String) => String = new Function2[String, String, String] {
